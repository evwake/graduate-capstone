...
schedule_table_rows = schedule_table.find_all('tr', attrs={'class': None})[118:273] # Get all regular season rows in the schedule table
...
for table_row in schedule_table_rows:
    ...
    if os.path.exists("output/" + game_name):
